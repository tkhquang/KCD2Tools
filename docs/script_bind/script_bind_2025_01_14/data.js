...
["GetMemoryUsage","CScriptBind_ActionMapManager__GetMemoryUsage@ICrySizer_@const.html","  This is GetMemoryUsage, a member of class CScriptBind_ActionMapManager.&#160;"],
...
["DeactivateParticleEmitter","CScriptBind_Entity__DeactivateParticleEmitter@IFunctionHandler_@int.html","  ! &#160;"],
...
["DestroyBBoxProxy","CScriptBind_Entity__DestroyBBoxProxy@IFunctionHandler_.html","  [WH:MR] Destroys the bbox proxy &#160;"],
...
["GetBBoxProxyBBox","CScriptBind_Entity__GetBBoxProxyBBox@IFunctionHandler_.html","  Returns the aabb of the bbox proxy &#160;"],
...
["SetBBoxProxyBBox","CScriptBind_Entity__SetBBoxProxyBBox@IFunctionHandler_@Vec3@Vec3.html","  Modifies the aabb of the bbox proxy &#160;"],
...
["GetTableLine","C_ScriptBindDatabase__GetTableLine@IFunctionHandler__@char_const_@C_TableBase__T_LineIdx.html","  Syntax: Database.GetTableLine(&quot;weapons&quot;, 5) Returns lua table with members of one data line. &#160;"],
...
["SetPlayerInteractiveState","C_ScriptBindDialog__SetPlayerInteractiveState@IFunctionHandler__.html","  Syntax: DialogModule.SetPlayerInteractiveState(stateName) Sets interactive state for players dialog. StateName must correspond to E_D_InteractiveState enum &#160;"],
...
["GetActorIdFromParameter","C_ScriptBindActor__GetActorIdFromParameter@IFunctionHandler_@uint.html","  &#160;"],
["GetMainChatNPC","C_ScriptBindActor__GetMainChatNPC@EntityId@const.html","  When given entity is in chat, returns Main chat NPC of this chat &#160;"],
["AcceptChatRequest","C_ScriptBindActor__AcceptChatRequest@IFunctionHandler_.html","  Syntax: Actor.AcceptChatRequest() Accepts chat request from this actor. &#160;"],
["AddBlood","C_ScriptBindActor__AddBlood@IFunctionHandler_@float.html","  Syntax: actor:AddBlood(1, &#39;head&#39;) Adds blood on all equipped items and body in given body part (or all body parts). &#160;"],
...
["CanBeButchered","C_ScriptBindActor__CanBeButchered@IFunctionHandler_.html","  Syntax: Actor.CanBeButchered() Returns true if actor can be butchered (Must be animal and not yet butchered) See also IsPlayerInButcheringDistance &#160;"],
["CanChat","C_ScriptBindActor__CanChat@IFunctionHandler_.html","  Syntax: Actor.CanChat() Checks if chat can be started with this actor. &#160;"],
...
["CanFollow","C_ScriptBindActor__CanFollow@IFunctionHandler_.html","  Syntax: Actor.CanFollow(npcEntity) Checks if this NPC can be followed be player. &#160;"],
...
["CanTalk","C_ScriptBindActor__CanTalk@IFunctionHandler_.html","  Syntax: Actor.CanTalk() Checks if this human have something to say.&#160;"],
...
["CleanDirt","C_ScriptBindActor__CleanDirt@IFunctionHandler__.html","  Syntax: actor:CleanDirt(1) Use only when you want to clean somebody programmatically. If you want to clean player after its in-game action, call WashDirtAndBlood instead.&#160;"],
...
["DoChat","C_ScriptBindActor__DoChat@IFunctionHandler_.html","  Syntax: Actor.DoChat() Start chat with the player. &#160;"],
...
["EquipClothingPreset","C_ScriptBindActor__EquipClothingPreset@IFunctionHandler_@char_const_.html","  Clothing =============================================  Syntax: Actor.EquipClothingPreset( &quot;46ea38bb-0be7-ca10-a8ac-d526056c04b3&quot; ) Clothing preset is equipped to actor. Dirt level of actor is used for new items. Health of equipment slots is ignored.&#160;"],
...
["GetInitialClothingPreset","C_ScriptBindActor__GetInitialClothingPreset@IFunctionHandler_.html","  Syntax: Actor.GetInitialClothingPreset() Returns string - GUID of initial clothing preset &#160;"],
["GetInitialWeaponPreset","C_ScriptBindActor__GetInitialWeaponPreset@IFunctionHandler_.html","  Syntax: Actor.GetInitialWeaponPreset() Returns string - GUID of initial weapon preset&#160;"],
...
["HasAcceptedChat","C_ScriptBindActor__HasAcceptedChat@IFunctionHandler_.html","  Syntax: Actor.HasAcceptedChat() Checks if this actor has accepted chat. &#160;"],
["HasChatRequest","C_ScriptBindActor__HasChatRequest@IFunctionHandler_.html","  Syntax: Actor.HasChatRequest() Checks if this actor requested a chat with the player. &#160;"],
["IsBodyMoreDirty","C_ScriptBindActor__IsBodyMoreDirty@IFunctionHandler_@float.html","  Syntax: actor:IsBodyMoreDirty(0.2) Returns true if body is more dirty than dirtLevel &#160;"],
...
["IsDead","C_ScriptBindActor__IsDead@IFunctionHandler_.html","  &#160;"],
["IsFlying","C_ScriptBindActor__IsFlying@IFunctionHandler__.html","  Syntax: Actor.IsFlying() Checks if the actor is flying. &#160;"],
["IsFollowing","C_ScriptBindActor__IsFollowing@IFunctionHandler_.html","  Syntax: Actor.IsFollowing(npcEntity) Checks if player is currently following the specified NPC. &#160;"],
...
["IsPlayerInButcheringDistance","C_ScriptBindActor__IsPlayerInButcheringDistance@IFunctionHandler_.html","  Syntax: Actor.IsPlayerInButcheringDistance() Returns true if actor is withing butchering distance Does not check other butchering conditions - use in conjunction with CanBeButchered &#160;"],
...
["IsWaitingForDialogueReply","C_ScriptBindActor__IsWaitingForDialogueReply@IFunctionHandler_.html","  Syntax: Actor.IsWaitingForDialogueReply() Checks if actor is waiting for player to reply in a dialogue. &#160;"],
...
["OpenChat","C_ScriptBindActor__OpenChat@IFunctionHandler_.html","  Syntax: Actor.OpenChat() Continue chat with the player. &#160;"],
["OpenItemMultiselectionFilter","C_ScriptBindActor__OpenItemMultiselectionFilter@IFunctionHandler_@ScriptHandle@char_const_.html","  Syntax: Actor:OpenItemMultiselectionFilter(entityId, filter) Opens UI for selecting multiple items with multiple amounts. &#160;"],
["OpenItemSelectionFilter","C_ScriptBindActor__OpenItemSelectionFilter@IFunctionHandler_@ScriptHandle@char_const_.html","  Syntax: Actor:OpenItemSelectionFilter(entityId, filter) Opens UI for selecting single item. &#160;"],
["OpenItemSelectionSharpening","C_ScriptBindActor__OpenItemSelectionSharpening@IFunctionHandler_@ScriptHandle.html","  Syntax: Actor:OpenItemSelectionSharpening(entityId) Returns more human readable representation of wuid.&#160;"],
["OpenItemTransferStore","C_ScriptBindActor__OpenItemTransferStore@IFunctionHandler_@ScriptHandle@framework__T_WUIDScriptType.html","  Syntax: Actor:OpenItemTransferStore(otherInventoryId) &#160;"],
...
["StartFollow","C_ScriptBindActor__StartFollow@IFunctionHandler_.html","  Syntax: Actor.StartFollow(npcEntity) Start following the NPC. &#160;"],
...
["WashDirtAndBlood","C_ScriptBindActor__WashDirtAndBlood@IFunctionHandler__.html","  Syntax: actor:WashDirtAndBlood(1, 0.5) Call when somebody washes himself in the game. &#160;"],
...
["C_ScriptBindAlchemyTable Class","C_ScriptBindAlchemyTable.html",""],
["GetTable","C_ScriptBindAlchemyTable__GetTable@IFunctionHandler_.html","  &#160;"],
["AttachTo","C_ScriptBindAlchemyTable__AttachTo@C_AlchemyTable_.html","  &#160;"],
["IsEnabled","C_ScriptBindAlchemyTable__IsEnabled@IFunctionHandler_.html","  Syntax: alchemyTable.IsEnabled() Checks whether the alchemy table is enabled for use by player. &#160;"],
["C_ScriptBindAnimDoor Class","C_ScriptBindAnimDoor.html",""],
["GetDoor","C_ScriptBindAnimDoor__GetDoor@IFunctionHandler_.html","  &#160;"],
["GetSoul","C_ScriptBindAnimDoor__GetSoul@UINT_PTR.html","  &#160;"],
["AttachTo","C_ScriptBindAnimDoor__AttachTo@C_AnimDoor_.html","  &#160;"],
["GetObjectAnimName","C_ScriptBindAnimDoor__GetObjectAnimName@IFunctionHandler_@ScriptHandle@bool@bool@bool.html","  Syntax: animDoor.GetObjectAnim(userId, true, false, true) Gets the animation name that should be played by the door object based on the situation and usage specified by the params&#160;"],
["GetUserAnimName","C_ScriptBindAnimDoor__GetUserAnimName@IFunctionHandler_@ScriptHandle@bool@bool@bool.html","  Syntax: animDoor.GetUserAnimName(userId, true, false, true) Gets the animation name that should be played by the user of the door when using the door.&#160;"],
["IsEndPointInPrivateArea","C_ScriptBindAnimDoor__IsEndPointInPrivateArea@IFunctionHandler_.html","  Syntax: animDoor:IsEndPointInPrivateArea() Returns true if any of the door&#39;s navigation endpoint is within a private area &#160;"],
["IsInteractive","C_ScriptBindAnimDoor__IsInteractive@IFunctionHandler_.html","  Syntax: animDoor.GetObjectAnim(userId, true, false, true) &#160;"],
["ReportClosed","C_ScriptBindAnimDoor__ReportClosed@IFunctionHandler_@ScriptHandle.html","  Syntax: animDoor.ReportClosed(userId) Should be called when the door is closed. &#160;"],
["ReportOpened","C_ScriptBindAnimDoor__ReportOpened@IFunctionHandler_@ScriptHandle.html","  Syntax: animDoor.ReportOpened(userId) Should be called when the door is opened. &#160;"],
["UpdateBeforeAnimation","C_ScriptBindAnimDoor__UpdateBeforeAnimation@IFunctionHandler_.html","  Syntax: animDoor.UpdateBeforeAnimation() Should be called when an animation is about to be played on the door so that the C_AnimDoor object has the chance to update some internal information before the animation starts, incl. audio settings. &#160;"],
...
["C_ScriptBindCarryableItem Class","C_ScriptBindCarryableItem.html",""],
["CanPickUp","C_ScriptBindCarryableItem__CanPickUp@IFunctionHandler_@ScriptHandle@ScriptHandle.html","  checks if the user is close to the item (wh_ent_CarryItemPileMaxDistance) and is in Idle state &#160;"],
["CanPickUpImpl","C_ScriptBindCarryableItem__CanPickUpImpl@C_Actor_@IEntity_.html","  &#160;"],
["PickUp","C_ScriptBindCarryableItem__PickUp@IFunctionHandler_@ScriptHandle@ScriptHandle.html","  &#160;"],
["PickUpImpl","C_ScriptBindCarryableItem__PickUpImpl@C_Actor_@IEntity_.html","  &#160;"],
["C_ScriptBindCarryItemPile Class","C_ScriptBindCarryItemPile.html",""],
["CanDeposit","C_ScriptBindCarryItemPile__CanDeposit@IFunctionHandler_@ScriptHandle@ScriptHandle.html","  &#160;"],
["CanPackAndPick","C_ScriptBindCarryItemPile__CanPackAndPick@IFunctionHandler_@ScriptHandle@ScriptHandle.html","  &#160;"],
["CanPickUp","C_ScriptBindCarryItemPile__CanPickUp@IFunctionHandler_@ScriptHandle@ScriptHandle.html","  &#160;"],
["Deposit","C_ScriptBindCarryItemPile__Deposit@IFunctionHandler_@ScriptHandle@ScriptHandle.html","  &#160;"],
["PickUp","C_ScriptBindCarryItemPile__PickUp@IFunctionHandler_@ScriptHandle@ScriptHandle.html","  &#160;"],
["C_ScriptBind_Cart Class","C_ScriptBind_Cart.html",""],
["CanPlayerMount","C_ScriptBind_Cart__CanPlayerMount@IFunctionHandler__@ScriptHandle@bool.html","  Syntax: Cart.CanPlayerMount(EntityId cartId, bool frontSeat) returns true if player can mount into cart&#160;"],
["MountPlayer","C_ScriptBind_Cart__MountPlayer@IFunctionHandler__@ScriptHandle@bool.html","  Syntax: Cart.MountPlayer(EntityId cartId, bool frontSeat) Mount player into cart&#160;"],
["C_ScriptBindDog Class","C_ScriptBindDog.html",""],
["GetDog","C_ScriptBindDog__GetDog@IFunctionHandler_.html","  &#160;"],
["AttachTo","C_ScriptBindDog__AttachTo@C_Dog_.html","  &#160;"],
["Bond","C_ScriptBindDog__Bond@IFunctionHandler_.html","  Syntax: Dog.Bond() Player bonds this dog &#160;"],
["CanBond","C_ScriptBindDog__CanBond@IFunctionHandler_.html","  Syntax: Dog.CanBond() Returns true, if player can bond this dog from this position &#160;"],
...
["GetSlotItemClassId","C_ScriptBindEntityModule__GetSlotItemClassId@IFunctionHandler__@ScriptHandle.html","  ItemSlot &#160;"],
...
["DoBonding","C_ScriptBindHuman__DoBonding@IFunctionHandler_@ScriptHandle.html","  Syntax: Human.DoBonding(EntityId horseId) Bond selected horse. &#160;"],
...
["DryHerb","C_ScriptBindHuman__DryHerb@IFunctionHandler_@framework__T_WUIDScriptType@int.html","  Syntax: Human.DryHerb(id, amount) Dry herbs functionality. &#160;"],
...
["GetTorchLightArchetype","C_ScriptBindHuman__GetTorchLightArchetype@IFunctionHandler_.html","  Syntax: Human.GetTorchLightArchetype() Gets the light archetype to use for torches for this human (can vary based on script contexts, is/isnt&#39;t player) &#160;"],
...
["InterruptDialogs","C_ScriptBindHuman__InterruptDialogs@IFunctionHandler_.html","  Syntax: Human.InterruptDialogs() Interrupts all ongoing dialogs. &#160;"],
...
["PrepareFood","C_ScriptBindHuman__PrepareFood@IFunctionHandler__@framework__T_WUIDScriptType@int@int.html","  Syntax: Human.PrepareFood(id, type, amount) Cooking functionality.&#160;"],
...
["RequestPickpocketing","C_ScriptBindHuman__RequestPickpocketing@IFunctionHandler__@ScriptHandle.html","  Syntax: Human.RequestPickpocketing(EntityId victimEntityId, mode) Start stealing from victim&#160;"],
...
["C_ScriptBindInteractionTrigger Class","C_ScriptBindInteractionTrigger.html",""],
["GetInteractionTrigger","C_ScriptBindInteractionTrigger__GetInteractionTrigger@IFunctionHandler_.html","  &#160;"],
["AttachTo","C_ScriptBindInteractionTrigger__AttachTo@I_InteractionTrigger_.html","  &#160;"],
["IsHoldEnabled","C_ScriptBindInteractionTrigger__IsHoldEnabled@IFunctionHandler_.html","  Syntax: interactionTrigger.IsHoldEnabled() Checks whether the trigger hold button is enabled for use by player. &#160;"],
["IsPressEnabled","C_ScriptBindInteractionTrigger__IsPressEnabled@IFunctionHandler_.html","  Syntax: interactionTrigger.IsPressEnabled() Checks whether the trigger press button is enabled for use by player. &#160;"],
["SetHeld","C_ScriptBindInteractionTrigger__SetHeld@IFunctionHandler_.html","  Syntax: interactionTrigger.SetHeld() Should be called when the trigger is held by player. &#160;"],
["SetPressed","C_ScriptBindInteractionTrigger__SetPressed@IFunctionHandler_.html","  Syntax: interactionTrigger.SetPressed() Should be called when the trigger is pressed by player. &#160;"],
["SetPriority","C_ScriptBindInteractionTrigger__SetPriority@IFunctionHandler_@int.html","  Syntax: interactionTrigger.SetPriority() Set the priority of this interactor trigger &#160;"],
...
["C_ScriptBindLockBase Class","C_ScriptBindLockBase.html",""],
["GetLockBase","C_ScriptBindLockBase__GetLockBase@IFunctionHandler_.html","  &#160;"],
["AttachTo","C_ScriptBindLockBase__AttachTo@C_LockBase_.html","  &#160;"],
["PlayerHoldsKey","C_ScriptBindLockBase__PlayerHoldsKey@IFunctionHandler_@char_const_.html","  Syntax: locpickable.PlayerHoldsKey() Returns whether the player has a key that matches this lock&#160;"],
["ReportLocked","C_ScriptBindLockBase__ReportLocked@IFunctionHandler_.html","  Syntax: locpickable.ReportLocked() Should be called when the lock is locked. &#160;"],
["ReportLockpicked","C_ScriptBindLockBase__ReportLockpicked@IFunctionHandler_.html","  Syntax: locpickable.ReportLockpickeded() Should be called when the lock is lockpicked. &#160;"],
["ReportUnlocked","C_ScriptBindLockBase__ReportUnlocked@IFunctionHandler_.html","  Syntax: locpickable.ReportUnlocked() Should be called when the lock is unlocked. &#160;"],
...
["BelongsToDeadBody","C_ScriptBindPickableItem__BelongsToDeadBody@IFunctionHandler_.html","  Syntax: self.item:BelongsToDeadBody() DEPRECATED Returns true if the item&#39;s owner is dead &#160;"],
["CanPickUp","C_ScriptBindPickableItem__CanPickUp@IFunctionHandler__@ScriptHandle.html","  Syntax: self.item:CanPickUp( ScriptHandle userId ) Checks if the item can be picked up by the user. &#160;"],
["CanSteal","C_ScriptBindPickableItem__CanSteal@IFunctionHandler__@ScriptHandle.html","  Syntax: self.item:CanSteal( ScriptHandle userId ) Checks if the item can be stolen by the user. &#160;"],
["CanUse","C_ScriptBindPickableItem__CanUse@IFunctionHandler__@ScriptHandle.html","  Syntax: self.item:CanUse( ScriptHandle userId ) Checks if the item can be used by the user. &#160;"],
["GetEntityHoldingInHand","C_ScriptBindPickableItem__GetEntityHoldingInHand@IFunctionHandler__.html","  Syntax: self.item:GetEntityHoldingInHand() Returns the script table of entity that is hodling this item, if ant&#160;"],
["GetExtensionParams","C_ScriptBindPickableItem__GetExtensionParams@IFunctionHandler_@char__@SmartScriptTable.html","  Syntax: self.item:GetExtensionParams( const char *extension, SmartScriptTable params ) Gets extension parameters. &#160;"],
["GetHealth","C_ScriptBindPickableItem__GetHealth@IFunctionHandler__.html","  Syntax: self.item:GetHealth() Gets item health. &#160;"],
["GetId","C_ScriptBindPickableItem__GetId@IFunctionHandler__.html","  Syntax: self.item:GetId() Gets item id &#160;"],
["GetLinkedOwner","C_ScriptBindPickableItem__GetLinkedOwner@IFunctionHandler_.html","  Syntax: self.item:GetLinkedOwner() Returns linked owner &#160;"],
["GetMaxHealth","C_ScriptBindPickableItem__GetMaxHealth@IFunctionHandler__.html","  Syntax: self.item:GetMaxHealth() Gets the maximum item health. &#160;"],
["GetMountedAngleLimits","C_ScriptBindPickableItem__GetMountedAngleLimits@IFunctionHandler__.html","  Syntax: self.item:GetMountedAngleLimits() Gets the mounted angle limits for the item. &#160;"],
["GetMountedDir","C_ScriptBindPickableItem__GetMountedDir@IFunctionHandler__.html","  Syntax: self.item:GetMountedDir() Gets the mounted direction for the item. &#160;"],
["GetOwnerId","C_ScriptBindPickableItem__GetOwnerId@IFunctionHandler__.html","  Syntax: self.item:GetOwnerId() Gets the identifier of the item&#39;s owner. &#160;"],
["GetParams","C_ScriptBindPickableItem__GetParams@IFunctionHandler__.html","  Syntax: self.item:GetParams() Gets the item parameters. &#160;"],
["GetPhase","C_ScriptBindPickableItem__GetPhase@IFunctionHandler_.html","  Syntax: self.item:GetPhase() Returns phase relative from 0 to 1. &#160;"],
["GetPhaseById","C_ScriptBindPickableItem__GetPhaseById@IFunctionHandler_.html","  Syntax: self.item:GetPhaseId() Returns absolute phase id from 0 to max phases. &#160;"],
["GetSlot","C_ScriptBindPickableItem__GetSlot@IFunctionHandler_@bool.html","  Syntax: self.item:GetSlot( bool usePresence ) Gets the slot that holds the item. Uses either the presence or the holder to determine the slot. May return invalid wuid if the item&#39;s presence/holder is not a slot &#160;"],
["GetStats","C_ScriptBindPickableItem__GetStats@IFunctionHandler__.html","  Syntax: self.item:GetStats() Gets the item statistics. &#160;"],
["GetUIName","C_ScriptBindPickableItem__GetUIName@IFunctionHandler__.html","  Syntax: self.item:GetUIName() Gets the UI name. &#160;"],
["IsDestroyed","C_ScriptBindPickableItem__IsDestroyed@IFunctionHandler__.html","  Syntax: self.item:IsDestroyed() Event that occurs when the item is destroyed. &#160;"],
["IsFromShop","C_ScriptBindPickableItem__IsFromShop@IFunctionHandler_.html","  Syntax: self.item:IsFromShop() Returns true if the item is owner by some shop and can be bought instead of picked &#160;"],
["IsMounted","C_ScriptBindPickableItem__IsMounted@IFunctionHandler__.html","  Syntax: self.item:IsMounted() Checks if the item is mounted. &#160;"],
["IsOversized","C_ScriptBindPickableItem__IsOversized@IFunctionHandler__.html","  Syntax: self.item:IsOversized() Returns true if the item is too big to be picket up &#160;"],
["IsUsed","C_ScriptBindPickableItem__IsUsed@IFunctionHandler__.html","  Syntax: self.item:IsUsed() Checks if the item is used. &#160;"],
["OnHit","C_ScriptBindPickableItem__OnHit@IFunctionHandler__@SmartScriptTable.html","  Syntax: self.item:OnHit( SmartScriptTable hitTable ) Events that occurs when the item is hit. &#160;"],
["OnSteal","C_ScriptBindPickableItem__OnSteal@IFunctionHandler__@ScriptHandle.html","  Syntax: self.item:OnSteal( ScriptHandle userId ) If user is player, asks if he wants to steal the item and steals it. &#160;"],
["OnUsed","C_ScriptBindPickableItem__OnUsed@IFunctionHandler__@ScriptHandle.html","  Syntax: self.item:OnUsed( ScriptHandle userId ) Events that occurs when the item is used. &#160;"],
["PlayAnimation","C_ScriptBindPickableItem__PlayAnimation@IFunctionHandler__@char__.html","  Syntax: self.item:PlayAnimation( const char *animationName ) Plays the specified animation. &#160;"],
["Reset","C_ScriptBindPickableItem__Reset@IFunctionHandler__.html","  Syntax: self.item:Reset() Resets the item. &#160;"],
["Select","C_ScriptBindPickableItem__Select@IFunctionHandler__@bool.html","  Syntax: self.item:Select( bool select ) Selects/deselects the item. &#160;"],
["SetExtensionActivation","C_ScriptBindPickableItem__SetExtensionActivation@IFunctionHandler__@char__@bool.html","  Syntax: self.item:SetExtensionActivation( const char *extension, bool activation ) Activates/deactivates an extension. &#160;"],
["SetExtensionParams","C_ScriptBindPickableItem__SetExtensionParams@IFunctionHandler_@char__@SmartScriptTable.html","  Syntax: self.item:SetExtensionParams( const char *extension, SmartScriptTable params ) Sets extension parameters. &#160;"],
["SetMountedAngleLimits","C_ScriptBindPickableItem__SetMountedAngleLimits@IFunctionHandler__@float@float@float.html","  Syntax: self.item:SetMountedAngleLimits( float min_pitch, float max_pitch, float yaw_range ) Sets the mounted angle limits (yaw-pitch). &#160;"],
["SetPhase","C_ScriptBindPickableItem__SetPhase@IFunctionHandler_@float.html","  Syntax: self.item:SetPhase(phase) Sets phase of this objects and reload its mode. Phase relative from 0 to 1. &#160;"],
["SetPhaseById","C_ScriptBindPickableItem__SetPhaseById@IFunctionHandler_@uint.html","  Syntax: self.item:SetPhaseById(id) Sets phase of this objects by phase id and reload its model. Id is absolute phase from 0 to max phases. Max phases needs to be known from DB. &#160;"],
["StartUse","C_ScriptBindPickableItem__StartUse@IFunctionHandler__@ScriptHandle.html","  Syntax: self.item:StartUse( ScriptHandle userId ) The specified user now will start to use the item. &#160;"],
["StopUse","C_ScriptBindPickableItem__StopUse@IFunctionHandler__@ScriptHandle.html","  Syntax: self.item:StopUse( ScriptHandle userId ) The specified user now will stop to use the item. &#160;"],
["Use","C_ScriptBindPickableItem__Use@IFunctionHandler__@ScriptHandle.html","  Syntax: self.item:Use( ScriptHandle userId ) The specified user now will use the item. &#160;"],
...
["CanBondHorse","C_ScriptBindPlayer__CanBondHorse@IFunctionHandler_@ScriptHandle.html","  Syntax: Player.CanBondHorse(horseEntityId) Returns if the player can bond a target horse &#160;"],
["CancelDogObjective","C_ScriptBindPlayer__CancelDogObjective@IFunctionHandler__.html","  &#160;"],
["CanChangeStanceObject","C_ScriptBindPlayer__CanChangeStanceObject@IFunctionHandler_@framework__T_WUIDScriptType.html","  Syntax: CanChangeStanceObject(Wuid stanceObjectId) Returns true if player either does not use any stance smart object, or if stanceObjectId is the one being used &#160;"],
...
["CanSleep","C_ScriptBindPlayer__CanSleep@IFunctionHandler_.html","  Syntax: Player.CanSleep() Returns the result of the if the player can sleep and the message (E_SkipTimeMessage) as a pair &#160;"],
...
["GetFlyMode","C_ScriptBindPlayer__GetFlyMode@IFunctionHandler_.html","  Syntax: Player.GetFlyMode() Returns fly mode of the player (FlyMode_Off, FlyMode_On, FlyMode_OnNoCollisions)&#160;"],
...
["IsCombatChatTarget","C_ScriptBindPlayer__IsCombatChatTarget@IFunctionHandler_@ScriptHandle.html","  Syntax: Player.IsCombatChatTarget(entityId) Returns true when player is in combat danger and target is threat for player &#160;"],
["IsLaying","C_ScriptBindPlayer__IsLaying@IFunctionHandler__.html","  Syntax: Player.IsLaying() Returns true when player is laying &#160;"],
["IsLockedToOpponent","C_ScriptBindPlayer__IsLockedToOpponent@IFunctionHandler_@ScriptHandle.html","  Syntax: Player.IsLockedToOpponent(entityId) Returns true when player is locked in melee combat to this entity &#160;"],
...
["SetAlcoTeleportTarget","C_ScriptBindPlayer__SetAlcoTeleportTarget@IFunctionHandler_@framework__T_WUIDScriptType.html","  Syntax: Player.SetAlcoTeleportTarget(targetWuid) Sets target place for alcoteleport. Player will be teleported there at the end of unconciousness. Player must be unconscious when this is called, otherwise it is ignored. Set to INVALID_WUID (0) to cancel previous teleport request. &#160;"],
["SetFlyMode","C_ScriptBindPlayer__SetFlyMode@IFunctionHandler__@int.html","  Syntax: Player.SetFlyMode(flyMode) Sets fly mode of the player (FlyMode_Off, FlyMode_On, FlyMode_OnNoCollisions) &#160;"],
...
["C_ScriptBindStash Class","C_ScriptBindStash.html",""],
["GetStash","C_ScriptBindStash__GetStash@IFunctionHandler_.html","  &#160;"],
["AttachTo","C_ScriptBindStash__AttachTo@C_Stash_.html","  &#160;"],
["DumpItemsToWorld","C_ScriptBindStash__DumpItemsToWorld@IFunctionHandler_.html","  &#160;"],
["GetMasterInventory","C_ScriptBindStash__GetMasterInventory@IFunctionHandler__.html","  Syntax: local inventoryId = stash.GetMasterInventory() If this stash is shared, returns id of master inventory. Returns invalid wuid otherwise. &#160;"],
["ReportClosed","C_ScriptBindStash__ReportClosed@IFunctionHandler_.html","  Syntax: stash.ReportClosed() Should be called when the stash is closed. &#160;"],
["ReportOpened","C_ScriptBindStash__ReportOpened@IFunctionHandler_@bool.html","  Syntax: stash.ReportOpened() Should be called when the stash is opened. &#160;"],
...
["GetRainIntensity","C_ScriptBindEnvironment__GetRainIntensity@IFunctionHandler_.html","  Syntax: EnvironmentModule.GetRainIntensity() Get current intensity of the rain.&#160;"],
...
["C_ScriptBindUI Class","C_ScriptBindUI.html",""],
["OnApseLinkNodeDespawn","C_ScriptBindUI__OnApseLinkNodeDespawn@IFunctionHandler_@ScriptHandle.html","  &#160;"],
["OnApseLinkNodeSpawn","C_ScriptBindUI__OnApseLinkNodeSpawn@IFunctionHandler_@ScriptHandle.html","  This is OnApseLinkNodeSpawn, a member of class C_ScriptBindUI.&#160;"],
["OnShopLinkNodeDespawn","C_ScriptBindUI__OnShopLinkNodeDespawn@IFunctionHandler_@ScriptHandle.html","  &#160;"],
["OnShopLinkNodeSpawn","C_ScriptBindUI__OnShopLinkNodeSpawn@IFunctionHandler_@ScriptHandle.html","  This is OnShopLinkNodeSpawn, a member of class C_ScriptBindUI.&#160;"],
["C_ScriptBind_Alchemy Class","C_ScriptBind_Alchemy.html",""],
["GetDisableReason","C_ScriptBind_Alchemy__GetDisableReason@IFunctionHandler_@int@int.html","  Syntax: Alchemy.GetDisableReason(EntityId user, item_type) returns string &#160;"],
...
["IsCrossCenteringEnabled","C_ScriptBind_Alchemy__IsCrossCenteringEnabled@IFunctionHandler_@int@int.html","  Syntax: Alchemy.IsCrossCenteringEnabled(EntityId user, item_type) returns if hint is enabled for selected alchemy item &#160;"],
...
["IsUsableVisibleFor","C_ScriptBind_Alchemy__IsUsableVisibleFor@IFunctionHandler_@int@int.html","  Syntax: Alchemy.IsUsableVisibleFor(EntityId user, item_type) returns true if item can be currently shown &#160;"],
["OnUse","C_ScriptBind_Alchemy__OnUse@IFunctionHandler_@int.html","  Syntax: Alchemy.OnUse(EntityId user) returns true &#160;"],
...
["C_ScriptBind_Blacksmithing Class","C_ScriptBind_Blacksmithing.html",""],
["CanUse","C_ScriptBind_Blacksmithing__CanUse@IFunctionHandler__@ScriptHandle@ScriptHandle.html","  Syntax: Blacksmithing.CanUse(EntityId user, EntityId pileId) returns true if smithery can be used &#160;"],
["StartMinigame","C_ScriptBind_Blacksmithing__StartMinigame@IFunctionHandler__@ScriptHandle@ScriptHandle.html","  Syntax: Blacksmithing.StartMinigame(EntityId user, EntityId pileId) Starts blacksmithing minigame. &#160;"],
...
["C_ScriptBind_HoleDigging Class","C_ScriptBind_HoleDigging.html",""],
["CheckPlayerAboveHole","C_ScriptBind_HoleDigging__CheckPlayerAboveHole@IFunctionHandler__@ScriptHandle.html","  Syntax: HoleDigging.CheckPlayerAboveHole(holeId) Check if player stands above hole &#160;"],
["C_ScriptBindMinigame Class","C_ScriptBindMinigame.html",""],
["CanUseMinigame","C_ScriptBindMinigame__CanUseMinigame@IFunctionHandler__@ScriptHandle.html","  Syntax: Minigame.CanUseMinigame(ScriptHandle playerId, int filterMask) Check if the minigame can start. Particular type of minigame can use different mask. By default all filters are enabled. Use disableMask to disable particular filter. Use Lua bit operations (bor) to compose bit values. For example: bor(E_MUF_CombatDanger,E_MUF_Other)&#160;"],
...
["C_ScriptBind_ShootingContest Class","C_ScriptBind_ShootingContest.html",""],
["HideHorseShootingContestTable","C_ScriptBind_ShootingContest__HideHorseShootingContestTable@IFunctionHandler_.html","  Syntax: ShootingContest.HideHorseShootingContestTable() Hide table ui for horse contest &#160;"],
["HideShootingContestTable","C_ScriptBind_ShootingContest__HideShootingContestTable@IFunctionHandler_.html","  Syntax: ShootingContest.HideShootingContestTable() Hide table ui for contest &#160;"],
["SetUI","C_ScriptBind_ShootingContest__SetUI@I_UIShootingContest_.html","  &#160;"],
["ShowHorseShootingContestTable","C_ScriptBind_ShootingContest__ShowHorseShootingContestTable@IFunctionHandler_@char_@char_@int@int@char_.html","  Syntax: ShootingContest.ShowHorseShootingContestTable(playerName, opponentName, playerScore, opponentScore, trackName) Show table ui for horse contest, names should be without @ &#160;"],
["ShowShootingContestTable","C_ScriptBind_ShootingContest__ShowShootingContestTable@IFunctionHandler_@char_@char_@char_@int@int@int@bool.html","  Syntax: ShootingContest.ShowShootingContestTable(playerName, opponentName1, opponentName2, playerArrows, opponentArrows1, opponentArrows2, isTargetVisible) Show table ui for contest, names should be without @, empty opponent name mean there is no opponent &#160;"],
["ShowShootingHit","C_ScriptBind_ShootingContest__ShowShootingHit@IFunctionHandler_@float@float.html","  Syntax: ShootingContest.ShowShootingHit(xPos, yPos) Arguments in relative space -1 to 1 &#160;"],
["UpdateHorseShootingContestTable","C_ScriptBind_ShootingContest__UpdateHorseShootingContestTable@IFunctionHandler_@int.html","  Syntax: ShootingContest.UpdateHorseShootingContestTable(playerScore) Update score in ui &#160;"],
["UpdateShootingContestTable","C_ScriptBind_ShootingContest__UpdateShootingContestTable@IFunctionHandler_@int@int@int@int@int@int.html","  Syntax: ShootingContest.UpdateShootingContestTable(playerArrows, opponentArrows1, opponentArrows2, playerPoints, opponentArrows1, opponentPoints1, opponentPoints2) Update score in ui, opponentArrows1 &lt; 0 mean there is no opponent1 &#160;"],
["C_ScriptBindSkipTime Class","C_ScriptBindSkipTime.html",""],
["GetSkipTimeMessageUIString","C_ScriptBindSkipTime__GetSkipTimeMessageUIString@IFunctionHandler_@int.html","  Syntax: SkipTime.GetSkipTimeMessageString(E_SkipTimeMessage message) returns the ui string for the skip time message. Returns nil for Empty message or if the messageType is invalid &#160;"],
["SetHudMessages","C_ScriptBindSkipTime__SetHudMessages@framework__I_UIHudMessages_.html","  &#160;"],
["C_ScriptBind_StoneThrowing Class","C_ScriptBind_StoneThrowing.html",""],
["CanUse","C_ScriptBind_StoneThrowing__CanUse@IFunctionHandler__@ScriptHandle@ScriptHandle.html","  Syntax: StoneThrowing.CanUse(EntityId user, EntityId pileId) returns true if pile can be used &#160;"],
["StartMinigame","C_ScriptBind_StoneThrowing__StartMinigame@IFunctionHandler__@ScriptHandle@ScriptHandle.html","  Syntax: StoneThrowing.StartMinigame(EntityId user, EntityId pileId) Starts stone throwing minigame. &#160;"],
...
["AddLocationPoint","C_ScriptBindRPGModule__AddLocationPoint@IFunctionHandler_@ScriptHandle.html","  Syntax: RPG.AddLocationPoint(entityId) Registers location point entity into entity manager &#160;"],
...
["GetFactionById","C_ScriptBindRPGModule__GetFactionById@IFunctionHandler_@char_.html","  Syntax: RPG.GetFactionById(factionId) Returns faction with the given id or nil if no such faction exists. &#160;"],
...
["GetIndulgencePrice","C_ScriptBindRPGModule__GetIndulgencePrice@IFunctionHandler_.html","  Syntax: RPG.GetIndulgencePrice() Returns indulgence price in decigroschen. 0 means no indulgence necessary -- all public friends are at or above their base reputation value. &#160;"],
...
["AddBuff","C_ScriptBindSoul__AddBuff@IFunctionHandler__@char__.html","  Syntax: soul:AddBuff(string buff_id[, string perk_id]) Adds buff identified by the database id. Returns the instance id. If the buff is the result of a perk, optional perk_id can be used to notify GUI. &#160;"],
...
["CanEatItem","C_ScriptBindSoul__CanEatItem@IFunctionHandler_@char_.html","  Syntax: soul:CanEatItem(&quot;89dada87-6e6c-5d2c-a17a-483ada14b90b&quot;) Checks if soul can eat the specified item class. Return true if so, false otherwise. &#160;"],
...
["EatItem","C_ScriptBindSoul__EatItem@IFunctionHandler_@char_.html","  Syntax: soul:EatItem(&quot;89dada87-6e6c-5d2c-a17a-483ada14b90b&quot;) Tries to eat an instance of the specified item class. Returns true if the item has been eaten (this includes checking if the item can be eaten), returns false otherwise. &#160;"],
...
["GetPerceivedFaction","C_ScriptBindSoul__GetPerceivedFaction@IFunctionHandler_.html","  Syntax: soul:GetPerceivedFaction() Returns the perceived faction (calculated from all cloths) for this soul.&#160;"],
...
["HasPerk","C_ScriptBindSoul__HasPerk@IFunctionHandler__@char_@bool.html","  Syntax: soul:HasPerk(&quot;89dada87-6e6c-5d2c-a17a-483ada14b90b&quot;, true) Check if soul has perk and use it.&#160;"],
["HasScriptContext","C_ScriptBindSoul__HasScriptContext@IFunctionHandler__@char_.html","  Syntax:: soul:HasScriptContext(&quot;script_context_name_from_db&quot;) Checks if soul currently has script context active&#160;"],
...
["IsInTenseCircumstance","C_ScriptBindSoul__IsInTenseCircumstance@IFunctionHandler_.html","  Syntax: soul:IsInTenseCircumstance() returns 1 if the soul in in tense circumstance state &#160;"],
["IsLegalToLoot","C_ScriptBindSoul__IsLegalToLoot@IFunctionHandler_.html","  Syntax: soul:IsLegalToLoot() Check whether looting the soul (dead or unconscious) will not be seen as a crime &#160;"],
...
["Reset","C_ScriptBindStatistics__Reset@IFunctionHandler__@char_.html","  Syntax: Statistics.Reset(statisticName); Resets a statistics counter. &#160;"],
...
["IsLinkedWithShop","C_ScriptBindShop__IsLinkedWithShop@IFunctionHandler__@ScriptHandle.html","  WH_CTSW(WH_CTSW_EDITOR) &#160;"],
["IsShopOpened","C_ScriptBindShop__IsShopOpened@IFunctionHandler_@ScriptHandle.html","  Finds shop by the linkedEntity (stash) and returns true if it is opened. False if it is closed or not a shop&#39;s linked entity. &#160;"],
["OnPropertyChange","C_ScriptBindShop__OnPropertyChange@IFunctionHandler__@ScriptHandle.html","  &#160;"],
["OpenInventory","C_ScriptBindShop__OpenInventory@IFunctionHandler__@ScriptHandle@bool.html","  Syntax: Shops.OpenInventory(entityId, bCanHaggle) Opens the shop UI with the specified shopkeeper.&#160;"],
...
["SetShopModule","C_ScriptBindShop__SetShopModule@C_ShopModule_.html","  This is SetShopModule, a member of class C_ScriptBindShop.&#160;"],
["C_PlayerStateHandlerScriptBind Class","C_PlayerStateHandlerScriptBind.html",""],
["ChangeStance","C_PlayerStateHandlerScriptBind__ChangeStance@IFunctionHandler_@framework__T_WUIDScriptType@char_.html","  Syntax: ChangeStance(Wuid stanceObject, string stance) Executes the NPC state change request with the specified stance as the required state &#160;"],
["ChangeUnstance","C_PlayerStateHandlerScriptBind__ChangeUnstance@IFunctionHandler_@framework__T_WUIDScriptType@char_.html","  Syntax: ChangeUnstance(Wuid unstanceObject, string unstance) Executes the NPC state change request with the specified unstance as the required state. The unstanceObject may be invalid wuid for unstance without location object. The script bind may contain optional parameters: string slaveLinkName &#160;"],
["ChangeUnstanceJoined","C_PlayerStateHandlerScriptBind__ChangeUnstanceJoined@IFunctionHandler_@framework__T_WUIDScriptType@char_@SmartScriptTable.html","  Syntax: ChangeUnstaceJoined(Wuid unstanceObject, string unstance, ScriptTable synchronizationData) Executes the NPC state change request with the specified unstance as the requested state. The difference to previous script bind is that this one provides a way to executed joined unstance. The script bind may contain optional parameter: string slaveLinkName &#160;"],
["EndHostResourcesPlayAnimationAction","C_PlayerStateHandlerScriptBind__EndHostResourcesPlayAnimationAction@IFunctionHandler_.html","  Syntax: EndHostResourcesPlayAnimationAction() Ends hosting resources previously requested by HostResourcesPlayAnimationAction. It is not necessary to call this function if PlayAnimationAction is called. &#160;"],
["HostResourcesPlayAnimationAction","C_PlayerStateHandlerScriptBind__HostResourcesPlayAnimationAction@IFunctionHandler_@framework__T_WUIDScriptType@char_@char_@ScriptHandle@bool.html","  Syntax: HostResourcesPlayAnimationAction(Wuid alignObject, string fragment, string tags, EntityId callbackEntityId, bool isHold) Starts holding resources necessary for the PlayAnimationAction. Return true if hosting of resources is successfully attempted, returns false otherwise. If the resource hosting is started successfully the callback will be called. Either OnResourcesHosted is called if when the resources are hosted or OnResourcesTakenAway if there is a NPC with priority override. The callback may be called directly from within calling this scripting (if resources are hosted immediately) The script bind may contain optional parameters: string slaveLinkName, string resourceOveride &#160;"],
["PlayAnimationAction","C_PlayerStateHandlerScriptBind__PlayAnimationAction@IFunctionHandler_@framework__T_WUIDScriptType@char_@char_@ScriptHandle@bool.html","  Syntax: PlayAnimationAction(Wuid alignObject, string fragment, string tags, EntityId triggerEntityId, bool isHold) Executes the NPC state change request with animation action as a extra action. The alignObject may be invalid wuid if the alignment and resource hosting is not required. The script bind may contain optional parameters: string slaveLinkName, string resourceOveride, string triggerPointId, bool allowTorchForPlayer &#160;"],
["PlayAnimationActionJoined","C_PlayerStateHandlerScriptBind__PlayAnimationActionJoined@IFunctionHandler_@framework__T_WUIDScriptType@char_@char_@SmartScriptTable@ScriptHandle@bool.html","  Syntax: PlayAnimationAction(Wuid alignObject, string fragment, string tags, ScriptTable synchronizationData, EntityId triggerEntityId, bool isHold) Executes the NPC state change request with animation action as a extra action. The animation action is synchronized according to the synchronization data. The alignObject may be invalid wuid if the alignment and resource hosting is not required. The script bind may contain optional parameters: string slaveLinkName, string resourceOveride, string triggerPointId, bool allowTorchForPlayer &#160;"],
["StartMinigame","C_PlayerStateHandlerScriptBind__StartMinigame@IFunctionHandler_@ScriptHandle@int@framework__T_WUIDScriptType@char_@int.html","  Syntax: StartMinigame(EntityId minigameObjectId, int minigameType, Wuid, resourceObjectId, string resourceName, int interruptUrgency) Starts minigame after the resource is hosted by the player state handler. If defined by a link from resource object, an interrupt is scheduled to the blocking NPC using the specified urgency &#160;"],
...
["AddLink","C_ScriptBindXGenAIModule__AddLink@IFunctionHandler_@framework__T_WUIDScriptType@framework__T_WUIDScriptType@char_.html","  Syntax: XGenAIModule.AddLink( fromId, toId, &#39;TagName&#39;); Adds a link between the linkable objects from and to. The specified tag is used - it must exists! Returns true if the link has been added, false otherwise. &#160;"],
...
["FindLinks","C_ScriptBindXGenAIModule__FindLinks@IFunctionHandler_@framework__T_WUIDScriptType@char_.html","  Syntax: XGenAIModule.FindLinks( fromId, &#39;TagName&#39;); Returns all links from given linkableObject with a given tag. Results are stored in array Returns NULL in case of failure &#160;"],
...
["GetOwner","C_ScriptBindXGenAIModule__GetOwner@IFunctionHandler_@framework__T_WUIDScriptType.html","  Syntax: XGenAIModule.GetOwner( myLinkableObjectWuid ); Finds out ownership of given linkable object. Returns wuid of the owner NPC or invalid wuid if there is no owner. &#160;"],
...
["HasClothingLink","C_ScriptBindXGenAIModule__HasClothingLink@IFunctionHandler_@framework__T_WUIDScriptType.html","  Syntax: XGenAIModule.ClothingLink(wuid); Returns true if the stash has any scheduler clothing link Retunrs NULL in case of failure &#160;"],
["IgnorePerception","C_ScriptBindXGenAIModule__IgnorePerception@IFunctionHandler_@framework__T_WUIDScriptType@framework__T_WUIDScriptType@char_@bool@bool.html","  Syntax: XGenAIModule.IgnorePerception(WUID perceptorId, WUID perceptibleId, string timeout, bool isWorldTime, bool uninterruptible); Make perceptor ignore a perceptible. &#160;"],
["IsOneshotAvailable","C_ScriptBindXGenAIModule__IsOneshotAvailable@IFunctionHandler_@framework__T_WUIDScriptType@char_.html","  &#160;"],
["IsOneshotBlocked","C_ScriptBindXGenAIModule__IsOneshotBlocked@IFunctionHandler_@framework__T_WUIDScriptType@char_.html","  &#160;"],
...
["IsStanceAvailable","C_ScriptBindXGenAIModule__IsStanceAvailable@IFunctionHandler_@framework__T_WUIDScriptType.html","  &#160;"],
["IsStanceBlocked","C_ScriptBindXGenAIModule__IsStanceBlocked@IFunctionHandler_@framework__T_WUIDScriptType.html","  &#160;"],
["IsUnstanceAvailable","C_ScriptBindXGenAIModule__IsUnstanceAvailable@IFunctionHandler_@framework__T_WUIDScriptType@char_.html","  &#160;"],
["IsUnstanceBlocked","C_ScriptBindXGenAIModule__IsUnstanceBlocked@IFunctionHandler_@framework__T_WUIDScriptType@char_.html","  &#160;"],
...
["SendMessageToEntityArray","C_ScriptBindXGenAIModule__SendMessageToEntityArray@IFunctionHandler__@framework__T_WUIDScriptType@char_const_@ScriptAnyValue.html","  &#160;"],
...
["SpawnEntity","C_ScriptBindXGenAIModule__SpawnEntity@IFunctionHandler_@SmartScriptTable.html","  Syntax: XGenAIModule.SpawnEntity{ Name=&quot;...&quot;, ... } or XGenAIModule.SpawnEntity(params), where params is table with Properties, named after individual arguments&#160;"],
...
["HideCurrentTutorial","CScriptBindGame__HideCurrentTutorial@IFunctionHandler__.html","  Syntax: Game.HideTutorial() Hide actually displayed tutorial message. &#160;"],
...
["HideTutorial","CScriptBindGame__HideTutorial@IFunctionHandler_@char_.html","  Syntax: Game.HideTutorial(name) Hides tutorial if currently show. If tutorial is not show right now, nothing happens. &#160;"],
...
["ResetTutorial","CScriptBindGame__ResetTutorial@IFunctionHandler__@char_.html","  Syntax: Game.ResetTutorial(name) Resets the tutorials making it possible to display again.&#160;"],
...
["ShowTutorial","CScriptBindGame__ShowTutorial@IFunctionHandler__@char__.html","  Syntax: Game.ShowTutorial(name) Shows tutorial message. Other tutorial parameters are specified in the game table. &#160;"],
["SpawnPrefab","CScriptBindGame__SpawnPrefab@IFunctionHandler_@ScriptHandle@char_@uint32.html","  &#160;"],
...
["SetUIHudMessages","CScriptBindGame__SetUIHudMessages@framework__I_UIHudMessages_.html","  &#160;"],
...
["AssignInventoryToStash","C_ScriptBindEditor__AssignInventoryToStash@IFunctionHandler_@ScriptHandle@char_.html","  &#160;"],
["ClearSelection","C_ScriptBindEditor__ClearSelection@IFunctionHandler__.html","  &#160;"],
["GetSelectedEntityName","C_ScriptBindEditor__GetSelectedEntityName@IFunctionHandler__.html","  &#160;"],
["SelectObject","C_ScriptBindEditor__SelectObject@IFunctionHandler__@char_.html","  &#160;"],
];
