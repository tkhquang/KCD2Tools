...
namespace TPVCamera
{
    ...
    enum class GameState : uint32_t
    {
        ...
        Overlay = 1u << 1,
        /**
         * @brief Combat camera active (weapon drawn; also set while aiming a missile weapon, which
         *        additionally sets @ref Aiming).
         */
        Combat = 1u << 2,
        /// Player mounted on horseback (E_StanceCategory horse = 5).
        Mount = 1u << 3,
        /// Dialogue camera active.
        Dialogue = 1u << 4,
        /// Any minigame on screen (umbrella; a Minigame* child below identifies which).
        Minigame = 1u << 5,
        /// Aiming or drawing a missile weapon (bow/crossbow).
        Aiming = 1u << 6,
        /// Player crouching / sneaking (E_StanceCategory crouch = 6).
        Crouch = 1u << 7,
        ...
        /// Lying down (E_StanceCategory lying = 2): sleeping in bed.
        Lying = 1u << 8,
        /// Sitting (E_StanceCategory sitting = 3): bench / chair.
        Sitting = 1u << 9,
        /// Kneeling (E_StanceCategory kneel = 4).
        Kneel = 1u << 10,
        /// Riding / driving a cart (E_StanceCategory cart = 7).
        Cart = 1u << 11,
        ...
        /// Sharpening a blade on a grindstone.
        MinigameSharpening = 1u << 12,
        /// Reading a book or scroll.
        MinigameReading = 1u << 13,
        /// Brewing at an alchemy bench.
        MinigameAlchemy = 1u << 14,
        /// Picking a herb.
        MinigameHerbGathering = 1u << 15,
        /// Picking a lock.
        MinigameLockpicking = 1u << 16,
        /// Digging (treasure / grave).
        MinigameHoleDigging = 1u << 17,
        /// Dice (the one minigame that uses the dedicated minigame camera).
        MinigameDice = 1u << 18,
        /// Pickpocketing an NPC.
        MinigamePickpocketing = 1u << 19,
        /// Throwing a stone.
        MinigameStoneThrowing = 1u << 20,
        /// Archery range / contest.
        MinigameBattleArchery = 1u << 21,
        /// Distraction minigame.
        MinigameDistract = 1u << 22,
        /// Forging at the anvil.
        MinigameBlacksmithing = 1u << 23,
        /// Operating the forge bellows.
        MinigameForgeBuilder = 1u << 24,
    };
    ...
    inline constexpr std::array<MinigameInfo, 13> k_minigames{{
        ...
        {Constants::C_MINIGAME_PICKPOCKETING_RTTI_NAME, GameState::MinigamePickpocketing, "pickpocketing",
         "Pickpocketing"},
        {Constants::C_MINIGAME_BLACKSMITHING_RTTI_NAME, GameState::MinigameBlacksmithing, "blacksmithing",
         "Blacksmithing"},
        {Constants::C_MINIGAME_FORGE_BUILDER_RTTI_NAME, GameState::MinigameForgeBuilder, "forgebuilder",
         "Forge bellows"},
        ...
        {Constants::C_MINIGAME_STONE_THROWING_RTTI_NAME, GameState::MinigameStoneThrowing, "stonethrowing",
         "Stone throwing"},
