    ...
    namespace
    {
        ...
        bool redirect_interaction_ray(uintptr_t origin, uintptr_t dir) noexcept
        {
            ...
            __try
            {
                ...
                neworigin[0] = px + dx * adv;
                neworigin[1] = py + dy * adv;
                neworigin[2] = pz + dz * adv;
                o[0] = neworigin[0];
                o[1] = neworigin[1];
                o[2] = neworigin[2];
                d[0] = dnew[0];
            ...
            if (done)
            {
                ...
                s_dbg_cam[0] = neworigin[0];
                s_dbg_cam[1] = neworigin[1];
                s_dbg_cam[2] = neworigin[2];
                s_dbg_valid = true;
            }
            return done;
        }
        ...
        void maybe_log_status() noexcept
        {
            ...
            if (s_dbg_valid)
            {
                log.trace("InteractionHook[run]: rayBuilds={} interactionCalls={} redirects={} lastReason={} "
                          ...
                          "dirOld=({}, {}, {}) -> dirNew=({}, {}, {})",
                          total, look, red, s_last_reason, osc, ofc, s_dbg_eye[0], s_dbg_eye[1], s_dbg_eye[2],
                          s_dbg_cam[0], s_dbg_cam[1], s_dbg_cam[2], s_dbg_dir_old[0], s_dbg_dir_old[1],
                          s_dbg_dir_old[2], s_dbg_dir_new[0], s_dbg_dir_new[1], s_dbg_dir_new[2]);
            }
            else
            {
                log.trace("InteractionHook[run]: rayBuilds={} interactionCalls={} redirects={} lastReason={} "
