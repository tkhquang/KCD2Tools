    ...
    bool initialize_ui_overlay_hooks()
    {
        ...
        try
        {
            ...
            auto hide_result = hook_manager.create_inline_hook(
                "HideOverlays", hide_addr, reinterpret_cast<void *>(hide_overlays_detour),
                reinterpret_cast<void **>(&s_hide_overlays_original), hook_config);
            ...
            auto show_result = hook_manager.create_inline_hook(
                "ShowOverlays", show_addr, reinterpret_cast<void *>(show_overlays_detour),
                reinterpret_cast<void **>(&s_show_overlays_original), hook_config);
