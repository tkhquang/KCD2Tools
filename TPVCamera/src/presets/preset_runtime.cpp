...
namespace TPVCamera::Presets
{
    namespace
    {
         ...
         *          low: Aiming > Crouch > Combat > Mount > Lying > Sitting > Kneel > Cart. The stance bits
         *          (Mount, Crouch, Lying, Sitting, Kneel, Cart) are mutually exclusive in practice, so their
