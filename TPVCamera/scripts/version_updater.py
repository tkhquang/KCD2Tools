...
3. Updates version in KCD2_TPVCamera_Readme.txt
...
README_TXT = BASE_DIR / "build" / "template" / "KCD2_TPVCamera_Readme.txt"
...
def update_readme_txt(version):
    """Update version in KCD2_TPVCamera_Readme.txt using string operations instead of regex."""
    ...
    try:
        ...
        print(f"Error updating KCD2_TPVCamera_Readme.txt: {str(e)}")
...
"""
    ...
    if changelog_entry:
        ...
        if not version_in_links:
            version_links.append((version, f"https://github.com/tkhquang/KCD2Tools/releases/tag/TPVCamera-v{version}"))
...
def main():
    ...
    if args.command == "bump":
        ...
        # Update KCD2_TPVCamera_Readme.txt with the new version
