...
bool GetPlayerWorldTransform(::Vector3 &outPosition, ::Quaternion &outOrientation)
{
    ...
    const Constants::Matrix34f &playerMatrix =
        *reinterpret_cast<const Constants::Matrix34f *>(matrix_address);
